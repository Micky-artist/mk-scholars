...
$formData = [
    'courses' => $_POST['courses'] ?? ['30-Day Live Coding Bootcamp'],
...
<head>
    ...
    <title>Register - Coding Bootcamp</title>
...
<body>
    ...
    <div class="container py-5">
        <form method="POST" class="bg-white p-4 rounded shadow-sm form-section">
            <div class="row">
                <div class="col-md-6">
                    <h3 class="mb-4">Register for Coding Bootcamp</h3>

                    <div class="course-card active"
                        data-course-id="1"
                        data-course-name="30-Day Live Coding Bootcamp"
                        data-course-amount="25000">
                        <div class="d-flex align-items-center justify-content-between">
                            <h4 class="mb-0">30-Day Live Coding Bootcamp (25,000 RWF)</h4>
                ...
                <div class="col-md-6">
                    ...
                    <div class="selected-courses">
                        <h4>Course</h4>
                        <ul>
                            <li>30-Day Live Coding Bootcamp</li>
                        </ul>
                    </div>
