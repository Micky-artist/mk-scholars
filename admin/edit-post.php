...
include("./php/updatePost.php");
include("./php/editPost.php");
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="form-horizontal" enctype="multipart/form-data" method="post">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" name="postTitle" id="title"
                                                    placeholder="Post Title" value="<?php echo $getPostDesc['postTitle'] ?>"/>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9">
                                                <div class="custom-file">
                                                    <input type="file" name="projectImg"  value="<?php echo "../uploads/posts/".$getPostDesc['projectImg1'] ?>" accept="image/*" class="custom-file-input"
                                                        id="validatedCustomFile"  />
                                                    <label class="custom-file-label" for="validatedCustomFile">
                                                    <?php echo $getPostDesc['projectImg1'] ?></label>
                                    ...
                                    <textarea type="text" id="post" name="shortDescription" class="form-control" rows="5" required><?php echo $getPostDesc['shortDescription'] ?></textarea>


                                    <!-- </div> -->
                                    <label class="card-title">Project description</label>
                                    <textarea type="text" id="post" name="projectDescription" class="text-jqte" rows="20" required><?php echo $getPostDesc['projectDescription'] ?></textarea>

                            </div>
                            <div class="border-top">
                                <div class="card-body">
                                    <button name="updatePost" class="btn btn-primary">
                                        Update
                                    </button>
                                </div>
                            </div>
