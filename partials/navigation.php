...
<div class="top-bar">
	<div class="top-bar-content">
		...
		<div class="social-icons">
			...
			<a href="https://whatsapp.com/channel/0029VbBFZSt8vd1L1hSex31Z" target="_blank" class="social-link whatsapp">
				<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 16 16">
			...
			<a href="https://www.instagram.com/mkscholars_?igsh=MTBxcmZzaDBtdW0zMA%3D%3D&utm_source=qr"  class="social-link instagram" target="_blank">
			<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 16 16">
...
.top-bar {
	...
	right: 0;
	z-index: 1000;
	box-shadow: 0 2px 10px rgba(14, 119, 194, 0.2);
}
...
.social-link.instagram {
	background: linear-gradient(135deg, #E4405F 0%, #F77737 25%, #FCAF45 50%, #FFDC80 75%, #C13584 100%);
	color: white;
}
...
.main-navigation {
	...
	left: 0;
	right: 0;
	z-index: 1500; /* above top bar to ensure dropdown visibility */
}
...
.dropdown-menu {
	...
	list-style: none;
	margin: 0;
	z-index: 1600; /* ensure above other elements */
}
...
.login-btn:hover {
	background: linear-gradient(135deg, #0a5a9a 0%, #062640 100%);
