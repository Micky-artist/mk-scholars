...
// $checkIfSubscribe = mysqli_query($conn, "SELECT * FROM subscription WHERE UserId=$id AND SubscriptionStatus=1 AND expirationDate>$date");
...
<div class="navigation">
    ...
    <div class="bannedContainer">
        <div class="failedTransaction"><i class="fa-solid fa-circle-xmark fa-beat"></i></div>
        <div><h1>Oops, Transaction Failed</h1></div>
        <div><p>Contact the administration for other information</p></div>
        <div><p>Phone: (+250) 786 585 008 || (+250) 783 876 662</p></div>
        <div><p>Or</p></div>
        <div class="backtohomebann"><a href="../index.php">Back home<i class="fa-solid fa-arrow-right"></i></a></div>
