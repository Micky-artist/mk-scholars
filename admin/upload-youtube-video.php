...
include("./php/videoOperations.php");

if (!hasPermission('ManageYoutubeVideo')) {
                                ...
                                <form class="form-horizontal" method="post">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group row">
                                            <label for="cono1" class="card-title">Video TItle</label>
                                            <div class="col-sm-9">
                                                <input type="hidden" value="<?php echo $vidId ?>" name="vidId">
                                                <input type="text" class="form-control" name="vidTitle" value="<?php echo $vidTitle ?>" placeholder="Video Title" required />
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="cono1" class="card-title">Video Link</label>
                                            <div class="col-sm-9">
                                                <textarea class="form-control" name="vidLink" cols="30" rows="10" id="" required>
                                                <?php echo $videoLink ?>
                                                </textarea>
                                        ...
                                        <div class="form-group row">
                                            <label for="cono1" class="card-title">Video Status</label>
                                            <div class="col-sm-9">
                                                <select type="text" name="vidStatus" class="form-control">
                                    ...
                                    <div class="card-body">
                                        ...
                                        if (isset($_GET['Edit'])) {
                                        ?>
                                            <button name="UpdateVid" class="btn btn-primary">
                                                Update
                                            </button>
                                        ...
                                        ?>
                                            <button name="addVid" class="btn btn-primary">
                                                Upload
                                            </button>
                                        <?php
                                        }
