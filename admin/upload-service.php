            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Upload Service</h4>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="form-horizontal" enctype="multipart/form-data" method="post">
                                    <div class="card-body">
                                        <h4 class="card-title">Upload Service</h4>
                                        <div class="form-group row">
                                            <label for="cono1" class="card-title">Service Name</label>
                                            <div class="col-sm-9">
                                                <input type="text" name="serviceName" class="form-control" id="title"
                                    ...
                                    <textarea type="text" id="post" name="serviceDescription" class="text-jqte" rows="20" required></textarea>

                            </div>
                            <div class="border-top">
                                <div class="card-body">
                                    <button name="uploadService" class="btn btn-primary">
                                        Save
                                    </button>
                                </div>
                            </div>
